              ...
              <div className="px-6 py-4">
                <div className="text-center py-8">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Cuando participes en eventos o interactúes con la comunidad, verás tu actividad aquí.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white shadow rounded-lg">
              ...
              <div className="px-6 py-4">
                <div className="text-center py-8">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    ¡Mantente atento! Pronto anunciaremos nuevos eventos de AWS.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="px-6 py-4 space-y-3">
                ...
                <a href="#" className="flex items-center p-3 rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500">Explorar eventos disponibles</p>
                  </div>
                </a>
                ...
                <a href="#" className="flex items-center p-3 rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div className="ml-3">
                    <p className="text-sm font-medium text-gray-900">Comunidad</p>
                    <p className="text-sm text-gray-500">Conectar con otros miembros</p>
                  </div>
                </a>

                {isAdmin && (
                  <a href="/admin" className="flex items-center p-3 rounded-lg hover:bg-red-50 transition-colors">
                    <div className="flex-shrink-0">
                    ...
                    <div className="ml-3">
                      <p className="text-sm font-medium text-red-900">Panel Admin</p>
                      <p className="text-sm text-red-600">Gestión administrativa</p>
                    </div>
                  </a>
                )}
              </div>
